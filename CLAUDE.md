...
这是一个 **Claude Code 插件**（`sci-research`，当前版本 1.16.3），通过多 Agent 编排，将"主题 + 比较实体 + 输出语言"转化为高质量研究/新闻产出。插件包含六条**完全独立**的流水线，互不共享 Agent：
